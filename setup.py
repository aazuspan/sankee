...
setup(
    ...
    description="Visualize classified time series data with interactive Sankey plots in Google Earth Engine.",  # Optional
    ...
    url="https://github.com/aazuspan/sankee",  # Optional
